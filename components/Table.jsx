    ...
    <div className="max-w-screen-xl mx-auto px-4 md:px-8">
      <div className="items-start justify-between md:flex">
        <div className="max-w-lg">
          <h3 className="text-white-800 text-xl font-bold sm:text-2xl">
            Create Tracking
          </h3>
          <p className="text-white-600 mt-2">
          Effortlessly monitor your product's journey from manufacturer to consumer with our secure blockchain-based tracking system
          </p>
        </div>
      ...
      <div className="mt-12 shadow-sm border rounded-lg overflow-x-auto">
        <table className="w-full table-auto text-sm text-left">
          ...
          <tbody className="text-grey-600 divide-y">
